 ...
 *   entirety and paste it here, changing the prefix from theme_ to incouragezen_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: incouragezen_breadcrumb()
 *
 *   where incouragezen is the name of your sub-theme. For example, the
 ...
 */
function incouragezen_theme(&$existing, $type, $theme, $path) {
...
function incouragezen_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function incouragezen_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
 ...
 */
function incouragezen_preprocess_node(&$vars, $hook) {
  // $vars['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // incouragezen_preprocess_node_page() or incouragezen_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function incouragezen_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function incouragezen_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
